...
# def test_stieltjes_laguerre():
#     n = 5
#     alpha0, beta0 = orthopy.tools.stieltjes(
#         lambda t, ft: sympy.integrate(ft * sympy.exp(-t), (t, 0, sympy.oo)), n
#     )
#
#     rc = orthopy.e1r.RecurrenceCoefficients("monic", symbolic=True)
#     _, alpha1, beta1 = numpy.array([rc[k] for k in range(n)]).T
#
#     assert (alpha0 == alpha1).all()
#     assert (beta0 == beta1).all()
#
#
# def test_stieltjes_laguerre2():
#     n = 10
#     alpha0, beta0 = orthopy.tools.stieltjes(
#         lambda t, ft:
#         sympy.integrate(ft * sympy.exp(-t), (t, 0, sympy.oo))
#         + sympy.integrate(ft * sympy.exp(t), (t, -sympy.oo, 0))
#         , n
#     )
#
#     print(alpha0)
